...
import { NetworkStackParamList, NetworkStackScreens } from './types';
...
function NetworkStack(parentProps: any) {
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        name={NetworkStackScreens.Maintenance}
      ...
      <Tab.Group>
        <Tab.Screen
          name={NetworkStackScreens.SearchAthletes}
        ...
        <Tab.Screen
          name={NetworkStackScreens.Friends}
          component={Friends}
          options={{
            title: 'Friends',
            animationEnabled: false,
        ...
        <Tab.Screen
          name={NetworkStackScreens.AthleteFriends}
          component={AthleteFriends}
          options={{
            title: 'Friends',
            headerRight: undefined,
          }}
        ...
        <Tab.Screen
          name={NetworkStackScreens.AthleteDashboard}
        ...
        <Tab.Screen
          name={NetworkStackScreens.AthleteWorkout}
          component={AthleteWorkout}
          options={{
            headerRight: undefined,
        ...
        <Tab.Screen
          name={NetworkStackScreens.AthleteExercise}
          component={Exercise}
          options={{
            headerTitle: '',
            headerRight: undefined,
        ...
        <Tab.Screen
          name={NetworkStackScreens.AthleteSearchExercises}
          component={AthleteSearchExercises}
          options={{
            headerTitle: '',
            headerRight: undefined,
            headerTransparent: true,
        ...
        <Tab.Screen
          name={NetworkStackScreens.AthleteAnalytics}
          component={AthleteAnalytics}
          options={{
            headerTitle: '',
            headerRight: undefined,
            headerTransparent: true,
        ...
        <Tab.Screen
          name={NetworkStackScreens.Chats}
          component={Chats}
          options={{
            title: 'Inbox',
            animationEnabled: false,
        ...
        <Tab.Screen
          name={NetworkStackScreens.Message}
          component={Message}
          options={{
            headerRight: undefined,
            title: '',
      ...
      <Tab.Group screenOptions={{ presentation: 'transparentModal' }}>
        <Tab.Screen
          name={NetworkStackScreens.AthleteModal}
          component={AthleteModal}
          options={{
            title: '',
            headerRight: undefined,
            headerTransparent: true,
        ...
        <Tab.Screen
          name={NetworkStackScreens.AthleteOverviewModal}
        ...
        <Tab.Screen
          name={NetworkStackScreens.DownloadProgramModal}
