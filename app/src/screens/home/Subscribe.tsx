  ...
  return (
    <SafeAreaView
      ...
      <View style={styles.middleContainer}>
        ...
        <PrimaryText styles={styles.subHeader}>
          Plan, Train, Evaluate, Repeat
        </PrimaryText>
      </View>
      <View style={styles.bottomContainer}>
        <View style={{alignItems: 'center'}}>
          <SecondaryText styles={styles.unlock} bold>
            All Access
          </SecondaryText>
          <SecondaryText styles={styles.unlockDes}>
            Use our tools to organize your workouts and track your progress.
          </SecondaryText>
          <PrimaryButton
            onPress={() => onSubscribe(Products.monthlyId_00_99)}
            styles={styles.btn}
            loading={loading}>
            $0.99 / Month
          </PrimaryButton>
          <PrimaryButton
            onPress={() => onSubscribe(Products.monthlyId_05_99)}
            styles={styles.btn}
            loading={loading}>
            $5.99 / Month
          </PrimaryButton>
          <Pressable
            ...
            onPress={() => onSubscribe(Products.monthlyId_00_00)}>
            <PrimaryText styles={styles.free}>
              {loading ? (
          ...
          <SecondaryText styles={styles.des}>
            Join a community of athletes who are trying to better themselves,
            just like you.
          </SecondaryText>
        </View>
...
export default connect(mapStateToProps, {handleSubscriptionPurchased})(
  Subscribe,
);
