export enum DemoStates {
  ...
  HOME_NAVIGATION_HEALTH = 'This section is the health section where you can evaluate your health trends.',
  HOME_HEALTH_EDIT = 'You can set your daily goals for sleep and calories burned.',
  HOME_HEALTH_OVERVIEW = 'You can also see your past week health trends.',
  ...
  EXERCISE_HOME = 'The exercise section is where you can take your training to the next level by creating goals and tracking your progress.',
  EXERCISE_HOME_EXERCISE_LIST = 'Each exercise has its own profile where you can create goals, analyze your performance, and make profile updates.',
  EXERCISE_HOME_ENDURANCE = 'Endurance related exercises has its own unique profile where you can also create goals and analyze your performance.',
  EXERCISE_HOME_PINNED = "The exercises that you've pinned will automatically appear here for quicker access.",
  BOTTOM_NAV = 'There are 4 sections of the app that you can visit via the bottom navigation bar.',
