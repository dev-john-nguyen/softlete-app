...
const widthOfListItem = normalize.width(1) - normalize.width(15) * 2;
...
const ProgramWorkouts = ({
  ...
  const onDayLongPress = (day: number) =>
    onPasteWorkout && onPasteWorkout(convertObjToDays(curWeek, day));
