  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        <SecondaryText styles={styles.headerText} bold>
          {renderActivityName(data.activityName)}
        </SecondaryText>
      ...
      <ScrollView style={styles.statsContainer} horizontal>
        <View style={styles.statsItemConatiner}>
          ...
          <SecondaryText styles={styles.itemText} bold>
            {renderSum(renderStatValues())} {renderLabel()}
          </SecondaryText>
        </View>
        <View style={styles.statsItemConatiner}>
          <View style={styles.statsHeaderContainer}>
          ...
          <SecondaryText styles={styles.itemText} bold>
            {renderMin(renderStatValues())} {renderLabel()}
          </SecondaryText>
        </View>
        <View style={styles.statsItemConatiner}>
          <View style={styles.statsHeaderContainer}>
          ...
          <SecondaryText styles={styles.itemText} bold>
            {renderAvg(renderStatValues())} {renderLabel()}
          </SecondaryText>
        </View>
        <View style={styles.statsItemConatiner}>
          <View style={styles.statsHeaderContainer}>
          ...
          <SecondaryText styles={styles.itemText} bold>
            {renderMax(renderStatValues())} {renderLabel()}
          </SecondaryText>
        </View>
      </ScrollView>
