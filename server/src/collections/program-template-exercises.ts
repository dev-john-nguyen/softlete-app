...
const programTemplateExercisesSchema = new mongoose.Schema(
  {
    data: {
      ...
      validate: [
        (val: ProgramExerciseDataProps[]) => val.length <= 50,
...
export default mongoose.model<ProgramTemplateExercisesProps>(
  'Program-Template-Exercise',
  programTemplateExercisesSchema,
);
