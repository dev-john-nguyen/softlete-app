    ...
    <div className="legal">
      <div className="content">
        ...
        <div className="legal-paragraph">
          ...
          <p className="legal-paragraph-content">
            By creating an account you agree to be bound by our Terms of Use and
            Privacy Policy, each of which is incorporated by reference into this
            agreement. If you do not accept and agree to be bound by all of the
            terms of this agreement, you should not use the Service. We may make
            changes to this Agreement and the Service from time to time. We may
            do this for a variety of reasons including to reflect changes in or
        ...
        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Your Account</h1>
          <p className="legal-paragraph-content">
            You are responsible for maintaining the confidentiality of the login
            credentials you use to sign up, and you are solely responsible for
            all activities that occur under those credentials. If you think your
            account has been compromised, please immediately contact us.
          </p>
        </div>

        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Agree To:</h1>
          <ul className="legal-paragraph-list">
            <li>
            ...
            <li>
              Treat others in a respectful manner, both on and off our Services
            </li>
            <li>Review safety tips.</li>
            <li>Present yourself respectfully.</li>
          </ul>
        </div>

        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Agree Not To:</h1>
          <ul className="legal-paragraph-list">
            <li>Stalk or harass any other user of the App.</li>
            <li>Act in an unlawful or unprofessional manner.</li>
            <li>Misrepresent your identity.</li>
            <li>
              Disclose information that you do not have the consent to disclose.
            </li>
            <li>
              Post or share <b>Prohibited Content.</b>
            </li>
            <li>
              Use our Services commit fraud, pyramid scheme, or other similar
              practices.
            </li>
          </ul>
        </div>
        ...
        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Prohibited Content</h1>
          <p className="legal-paragraph-content">
        ...
        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Content</h1>
          <p className="legal-paragraph-content">
            While using our Services, you will have access to: (i) content that
            you upload or provide while using our Services (“Your Content”);
            (ii) content that other users upload or provide while using our
            Services (“Member Content”); and (iii) content that Softlete
            provides on and through our Services (“Our Content”). In this
            agreement, “content” includes, without limitation, all text, images,
            video, audio, or other material on our Services, including
            information on users’ profiles and indirect messages between users.
          </p>
        </div>

        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Your Content</h1>
          <p className="legal-paragraph-content">
            ...
            us is accurate, including any information submitted through other
            third-party sources (if applicable), and that you will update your
            account information as necessary to ensure its accuracy.
            <br />
            The content included on your profile should be relevant to the
            intended use of our Services. You may not display any personal
            contact or banking information, whether concerning you or any other
            ...
            yourself to other users, you do so at your own risk. We encourage
            you to use caution in disclosing any personal information online.
            <br />
            Your profile will be visible to other people around the world, so be
            sure that you are comfortable sharing Your Content before you post.
            You acknowledge and agree that Your Content may be viewed by other
            users, and, notwithstanding these Terms, other users may share Your
            Content with third parties. By uploading Your Content, you represent
            and warrant to us that you have all necessary rights and licenses to
            do so and automatically grant us a license to use Your Content.
            <br />
        ...
        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">MEMBER CONTENT</h1>
          <p className="legal-paragraph-content">
            ...
            servers and displayed at the direction of that user.
            <br />
            You do not have any rights concerning Member Content, and you may
            only use Member Content to the extent that your use is consistent
            with our Services’ purpose of allowing us to communicate with and
            meet one another. You may not copy the Member Content or use Member
            Content for commercial purposes, to spam, to harass, or to make
        ...
        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Rights you Grant Us</h1>
          <p className="legal-paragraph-content">
            By creating an account, you grant us the right and license to host,
            store, copy, user, display, reproduce, adapt, edit, publish, modify,
            and distribute the information you authorize us to access.
            <br />
            ...
            Content on the Service and grant the license to us above.
            <br />
            We may delete or modify any Content that in our judgment violates
            this Agreement or may harm the reputation of the Service. You agree
            that we may access, preserve, and disclose your account information
            and Content if required to do so by law or in a good faith belief of
            illegal use of the Service.
          </p>
        </div>

        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Push Notifications</h1>
          <p className="legal-paragraph-content">
            We may provide you push notifications related to the App and our
            services, such as enhancements, events, and other promotions. After
            downloading the App, you will be asked to accept or deny push
            notifications. If you deny, you will not receive push notifications.
            If you accept, push notifications will automatically be sent to you.
            If you decide to opt out of push notifications, you can change the
            notification settings on your mobile device settings.
          </p>
        </div>

        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Privacy</h1>
          <p className="legal-paragraph-content">
            For Information about how we collect, use, and share your data,
            please visit our Privacy Policy page. By using us, you acknowledge
            that we may use such data in accordance with our Privacy Policy.
          </p>
        </div>

        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Disclaimer</h1>
          <p className="legal-paragraph-content">
            ...
            WARRANTY REQUIRED BY APPLICABLE LAW. NO ADVICE OR INFORMATION,
            WHETHER ORAL OR WRITTEN, SHALL CREATE ANY WARRANTY, REPRESENTATION,
            OR GUARANTEE NOT EXPRESSLY STATED IN THIS SECTION. ADDITIONALLY, WE
            DO NOT MAKE ANY WARRANTIES THAT THE APP OR SITE WILL BE
            ...
            MEMBERS. WE ARE NOT RESPONSIBLE FOR THE CONDUCT OF ANY USER. us
            GROUP DOES NOT CONDUCT CRIMINAL BACKGROUND CHECKS ON ITS MEMBERS.
          </p>
        </div>

        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Limitation of Liability</h1>
          <p className="legal-paragraph-content">
        ...
        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Indemnity</h1>
          <p className="legal-paragraph-content">
            All the actions you make and the information you post on our service
        ...
        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Account Termination</h1>
          <p className="legal-paragraph-content">
            These terms commence on the date you accept them and continue until
            terminated following the terms herein.
            <br />
            If you do not accept these terms, you can terminate your account by
            notifying us at any time or you can personally close your account
            through the app.
            <br />
            us may terminate or suspend these Terms If you violate these terms,
            or if we are required to do so by law.
            <br />
            If us determines, in its sole discretion, that you have breached any
            portion of these Terms, or have otherwise demonstrated conduct
            inappropriate for the App, we reserve the right to (a) warn you via
            email (to any email addresses you have provided to us) that you have
            violated the Terms; (b) delete your User Content; (c) discontinue
            your Account; (d) discontinue your subscription(s); (e) notify
            ...
            pursue to any other action which Bumble Group deems to be
            appropriate.
            <br />
        ...
        <div className="legal-paragraph">
          <h1 className="legal-paragraph-header">Additional</h1>
          <p className="legal-paragraph-content">
            We reserve the right to modify, amend, or change the terms at any
            time. The effective date of the updates will be posted at the bottom
            of the terms.
          </p>
        </div>
        ...
        <div className="legal-paragraph">
          <p className="legal-paragraph-content">
            <b>Last Updated Date: 1/4/2024</b>
          </p>
        </div>
      </div>
    </div>
